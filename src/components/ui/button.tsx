...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_4px_20px_hsl(175_80%_50%_/_0.25)]",
        ...
        hero: "bg-primary text-primary-foreground font-semibold hover:shadow-[0_4px_30px_hsl(175_80%_50%_/_0.4)] hover:scale-105 active:scale-100",
        heroOutline: "border-2 border-primary/60 bg-transparent text-foreground hover:border-primary hover:bg-primary/10 hover:shadow-[0_4px_20px_hsl(175_80%_50%_/_0.15)]",
      },
      size: {
